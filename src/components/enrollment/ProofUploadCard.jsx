        ...
        <form className="mt-4 grid gap-3.5">
          <div className="grid gap-3.5 md:grid-cols-2">
            <label className="grid gap-1.5">
              ...
              <input
                className="h-9.5 rounded-xl border border-white/10 bg-[#171224] px-3.5 text-xs.5 font-medium text-white outline-none transition focus:border-[#b467ff] focus:ring-1 focus:ring-[#b467ff]/20 placeholder-white/20"
